...
public class PermissionUtils {
    ...
    public static List<PrivacyBean> checkGrandState(Context context, List<PrivacyBean> permissions) {
        for (int i = 0; i < permissions.size(); i++) {
            ...
            permissions.get(i).setGranted(code == PackageManager.PERMISSION_GRANTED || codeExtra == PackageManager.PERMISSION_GRANTED);
        }
        return permissions;
    }
